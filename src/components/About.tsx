...
export default function About() {
    ...
    return (
        <div className="glass-card" style={{ padding: '1.25rem 1.25rem 1.5rem', lineHeight: 1.5 }}>
            ...
            <div style={{ borderTop: '1px solid rgba(255,255,255,0.06)', margin: '1.25rem 0 0', paddingTop: '1rem', display: 'flex', flexDirection: 'column', gap: '0.6rem' }}>
                {[
                    { href: 'https://github.com/scmlewis', label: 'scmlewis' },
                    { href: 'https://github.com/scmlewis/train.eta', label: 'scmlewis/train.eta' },
                ].map(link => (
                    <a
                        key={link.href}
                        href={link.href}
